...
const regions = {
    ...
    3: { id: 3, name: "North West", subtitle: "The Platinum Belt", focus: "Mining & Gambling", reqRank: 300, phase: 1 },
    4: { id: 4, name: "Free State", subtitle: "The Breadbasket", focus: "Agriculture & Gold", reqRank: 500, phase: 2 },
    5: { id: 5, name: "Northern Cape", subtitle: "The Desert", focus: "Diamonds & Solar", reqRank: 800, phase: 2 },
    6: { id: 6, name: "KwaZulu-Natal", subtitle: "The Harbor", focus: "Logistics & Import/Export", reqRank: 1200, phase: 3 },
    7: { id: 7, name: "Eastern Cape", subtitle: "The Windy City", focus: "Automotive & Livestock", reqRank: 1800, phase: 3 },
    8: { id: 8, name: "Western Cape", subtitle: "The Ganglands", focus: "Organized Crime & Parliament", reqRank: 2500, phase: 3 },
    9: { id: 9, name: "Continental Kingpin", subtitle: "Africa is yours", focus: "International Smuggling", reqRank: 5000, phase: 4 }
};
